...
//		 System.out.println("name: "+employees[10].getFirstName());
//		 employees[10].set_HoursWorked(l_hoursworked);
		 ...
		 if (l_hoursworked <= 30)
		 {
//			 employees[10].set_Special_session_overage(0);
			 System.out.println("-------------------------"); //fancy
			 employees[10].get_RegularPayOut();
			 System.out.println("Employee name: " + employees[10].toString());
//			 System.out.println("Wages paid = $" +  employees[10].get_RegularPayOut());
			 System.out.println("-------------------------"); //fancy
		 }//regular
...
//		 		System.out.println("Employee worked " + employees[10].get_OvertimeHours() +  " hours overtime, " + l_hoursworked + " hours total" );
		 		
		 	
		 		employees[10].set_Just_Overtime(employees[10].get_OvertimeHours(), l_regular_weekly_hours );
		 		
//		 		System.out.println("Wages paid (with overtime) = $" + employees[10].get_Just_Overtime());
